...
def menu_clase(lista_persona,lista_empleado,lista_avion,lista_vuelo,lista_viaje,lista_reserva):
    lista_persona=txt_lista_enlazada(lista_persona,Clases.persona,'Persona.txt')
    lista_empleado=txt_lista_normal(lista_empleado, Clases.empleado,'Empleado.txt')
    lista_avion=txt_lista_normal(lista_avion, Clases.avion,'Avion.txt')
    lista_vuelo=txt_lista_enlazada(lista_vuelo,Clases.persona,'Vuelo.txt')
    lista_viaje=txt_lista_enlazada(lista_viaje,Clases.persona,'Viaje.txt')
    lista_reserva=txt_lista_enlazada(lista_reserva,Clases.persona,'Reserva.txt')
    while True:
...
def menu():
    ...
    while boolean:
        ...
        numero = input("\n Si se quiere registrar ingrese el número 1 si ya tiene una cuenta ingrese el número 2, y si quiere salir marque 3:   ")
        ...
        if numero=='3':
            ...
            lista_enlazada_txt(lista_vuelo,"Vuelo.txt")
            lista_enlazada_txt(lista_viaje,"Viaje.txt")
            lista_enlazada_txt(lista_reserva,"Reserva.txt")
            boolean=False
