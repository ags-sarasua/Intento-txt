import Clases
import datetime
from listasenlazadas import Nodo,Lista
...
p1= Clases.persona("12345678", "Ana", "Fangio", "Femenino", datetime.date(1988, 4, 15), "Espana","ana@gmail.com","1111111111")
p2= Clases.persona("23456789", "Juan Bautista", "Alberdi", "Masculino", datetime.date(1995, 6, 27), "Argentina","juan@gmail.com","1234567890")
p3= Clases.persona("34567890", "Luisa", "Risso", "Femenino", datetime.date(1982, 8, 2), "Mexico","luisa@gmail.com","2345678901")
p4= Clases.persona("45678901", "Pedro", "Abascal", "Masculino", datetime.date(1998, 10, 11), "Francia","pedro@gmail.com","3456789012")
p5= Clases.persona("56789012", "Lucia", "Nagatomo", "Femenino", datetime.date(1975, 12, 4), "Japon","lucia@gmail.com","4567890123")
p6 = Clases.persona("67899123", "Lucia", "Fernández", "Femenino", datetime.date(1993,3,25), "Brasil","lucia2@gmail.com","567801234")
p7= Clases.persona("67890123", "Sofia", "Venegas", "Femenino", datetime.date(1986, 2, 20), "Brasil","sofia@gmail.com","6789012345")
p8= Clases.persona("78901234", "Javier", "Ielim", "Masculino", datetime.date(1992, 7, 8), "Rusia","javier12@gmail.com","7890123456")
p9= Clases.persona("89012345", "Carla", "Yema", "Femenino", datetime.date(1978, 9, 18), "Canada","carla@gamil.com","8901234567")
...
e2=Clases.empleado('87611321', 'Maria', 'Gomez', 'Femenino', datetime.date(1995, 2, 15).strftime('%d/%m/%Y'), 'Argentina', '5678', 'Piloto')
e3=Clases.empleado('23422789', 'Pedro', 'Rodriguez', 'Masculino', datetime.date(1985, 11, 20).strftime('%d/%m/%Y'), 'Espana', '9012', 'Tecnico')
e4=Clases.empleado('98733432', 'Ana', 'Gonzalez', 'Femenino', datetime.date(1992, 7, 7).strftime('%d/%m/%Y'), 'Mexico', '3456', 'Administrativo')
e5=Clases.empleado('34545890', 'Miguel', 'Fernandez', 'Masculino', datetime.date(1980, 3, 12).strftime('%d/%m/%Y'), 'Argentina', '7890', 'Tecnico')
...
e8=Clases.empleado('45677901', 'Julia', 'Fernandez', 'Femenino', datetime.date(1991, 1, 1).strftime('%d/%m/%Y'), 'Argentina', '1235', 'Piloto')
e9=Clases.empleado('89088345', 'Andres', 'Romero', 'Masculino', datetime.date(1982, 6, 10).strftime('%d/%m/%Y'), 'Colombia', '5679', 'Tecnico')
